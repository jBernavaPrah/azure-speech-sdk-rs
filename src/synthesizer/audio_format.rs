...
impl AudioFormat {
    pub(crate) fn header(&self, audio: &Vec<u8>) -> Vec<u8> {
        ...
        self.header_spec()
            .and_then(|spec| {
                ...
                let mut v = spec.into_header_for_infinite_file();

                let len = audio.len();

                // Set WAVE chunk size
                v[4] = ((len + v.len() - 8) & 0xFF) as u8;
                v[5] = (((len + v.len() - 8) >> 8) & 0xFF) as u8;
                v[6] = (((len + v.len() - 8) >> 16) & 0xFF) as u8;
                v[7] = (((len + v.len() - 8) >> 24) & 0xFF) as u8;

                // Set data chunk size

                if v[16] == 0x10 {
                    // pcm wave
                    v[0x28] = (len & 0xFF) as u8;
                    v[0x29] = ((len >> 8) & 0xFF) as u8;
                    v[0x2A] = ((len >> 16) & 0xFF) as u8;
                    v[0x2B] = ((len >> 24) & 0xFF) as u8;
                } else if v[16] == 0x28 {
                    // extensible
                    v[0x40] = (len & 0xFF) as u8;
                    v[0x41] = ((len >> 8) & 0xFF) as u8;
                    v[0x42] = ((len >> 16) & 0xFF) as u8;
                    v[0x43] = ((len >> 24) & 0xFF) as u8;
                } else {
                    unreachable!()
                }
    ...
    pub(crate) fn header_spec(&self) -> Option<hound::WavSpec> {
        match *self {
            
            // todo: check if this is really necessary when we will test it with the actual audio data
            
            // AudioFormat::Riff16Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 16_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff8Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 8_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff24Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 24_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff8Khz8BitMonoMULaw => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 8_000,
            //     bits_per_sample: 8,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw16Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 16_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw24Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 24_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw8Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 8_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw48Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 48_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff48Khz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 48_000,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw22050Hz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 22_050,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff22050Hz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 22_050,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw44100Hz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 44_100,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff44100Hz16BitMonoPcm => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 44_100,
            //     bits_per_sample: 16,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Raw8Khz8BitMonoALaw => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 8_000,
            //     bits_per_sample: 8,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // AudioFormat::Riff8Khz8BitMonoALaw => Some(hound::WavSpec {
            //     channels: 1,
            //     sample_rate: 8_000,
            //     bits_per_sample: 8,
            //     sample_format: hound::SampleFormat::Int,
            // }),
            // Formats that do not correspond to WAV will return None
            _ => None,
        }
    }
